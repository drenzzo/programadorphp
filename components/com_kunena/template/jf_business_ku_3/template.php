...
/**
* Kunena Component
* @package Kunena.Template.JF Business
*
...
class KunenaTemplatejf_business_ku_3 extends KunenaTemplate {
	...
	public function initialize() {
		KunenaFactory::loadLanguage('com_kunena.tpl_jf_business_ku_3');
