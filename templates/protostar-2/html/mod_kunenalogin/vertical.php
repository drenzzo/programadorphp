...
<div class="klogin-vert">
					...
					<div class="controls">
						<div class="input-prepend">
							<input 
								...
								tabindex="0" 
								placeholder="<?php echo JText::_('MOD_KUNENALOGIN_USERNAME') ?>" />
						</div>
					</div>
				</div>
					...
					<div class="controls">
						<div class="input-prepend">
							<input 
								...
								class="input-block-level" 
								tabindex="0" 
								placeholder="<?php echo JText::_('MOD_KUNENALOGIN_PASSWORD') ?>" />
						</div>
					</div>
				</div>
	...
	?>
				...
				<div id="form-login-submit" class="control-group center">
					<p>
						<button type="submit" tabindex="3" name="submit" class="btn btn-primary btn-block btn-large">
