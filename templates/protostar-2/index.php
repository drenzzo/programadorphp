...
<head>
	<script id="Cookiebot" src="https://consent.cookiebot.com/uc.js" data-cbid="8d51c8a0-fd35-49ac-b20d-f006ad02f32e" data-blockingmode="auto" type="text/javascript"></script>
	<script id="CookieDeclaration" src="https://consent.cookiebot.com/8d51c8a0-fd35-49ac-b20d-f006ad02f32e/cd.js" type="text/javascript" async></script>
	<meta name="viewport" content="width=device-width, initial-scale=1.0" />
	<jdoc:include type="head" />

	<!-- Global site tag (gtag.js) - Google Analytics -->
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-81907125-1"></script>
	<script>
		window.dataLayer = window.dataLayer || [];
		function gtag(){dataLayer.push(arguments);}
		gtag('js', new Date());

		gtag('config', 'UA-81907125-1');
	</script>

	<meta name="google-site-verification" content="4QtZ1yJm3qejo2milQL5QXdXkxWWaJEJhZRFzuNFYoI" />
	...
	<div class="body" id="top">
		<div class="wrapper">
			...
			<div class="row-fluid">
				...
				<div id="aside" class="span3 visible-desktop">
					<!-- Begin Right Sidebar -->
