...
<div class="ph-cart-module-box<?php echo $moduleclass_sfx ;?>">
	<sup id="phItemCartBoxCount"><?php echo $cart->getCartCountItems(); ?></sup>
	<div id="phItemCartBox">
...
// echo '<div id="phItemCartBoxCount">'. $cart->getCartCountItems().'</div>';
// $total = $cart->getCartTotalItems();
// echo '<div id="phItemCartBoxTotal">'. $cart->getCartTotalItems().'</div>';
?>
